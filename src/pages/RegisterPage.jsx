...
function Register() {
  ...
  return (
    <div className="min-h-screen mt-[70px] bg-gradient-to-br from-blue-50 to-indigo-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <motion.div
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="grid grid-cols-2 gap-4">
            <motion.button
              ...
              whileTap={{ scale: 0.99 }}
              type="button"
              onClick={() => socialRegister(googleProvider)}
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.99 }}
              type="button"
              onClick={() => socialRegister(githubProvider)}
              className="w-full flex justify-center items-center px-4 py-3 border border-gray-300 rounded-xl shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 transition-colors"
            >
              GitHub
            </motion.button>
